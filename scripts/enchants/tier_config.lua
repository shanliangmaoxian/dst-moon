...
TUNING.MOON_ENCHANT_TIERS = {
    ...
    Legend_LLJ              = "T0",  -- 蔷薇偶像恋恋酱：暴击13+爆伤14+移速52（骰子roll5/14+恋恋在场专属获取）
    ...
    Legend_WYWQ           = "T1",  -- 无欲无求：禅定回20%三维+减伤95%
    ...
    Legend_HUAIMINMIN     = "T1",  -- 怀民民：攻/范围+25%（镜华翻倍+真伤+夜晚催眠）
    ...
    Legend_GUA          = "T2",  -- 挂！每日天降奖池（天降物资/附魔石/粑粑雨彩蛋）
    Legend_HJBH         = "T2",  -- 厚积薄发：15秒蓄力后下次攻击放范围真伤
    Legend_DUNAI        = "T2",  -- 毒奶：攻击转1.5倍治疗+溢出降血上限（特殊打法）
    Legend_DWD          = "T2",  -- 大卫戴：料理溢出治疗转血上限-移速+治疗池
    ...
    Legend_WDSN        = "T3",  -- 我打宿傩？：增伤1+爆率2%+爆伤10%+封疗（仅世界天数25~50）
    Legend_YNWG        = "T3",  -- 雨女无瓜：暴击-20%爆伤+200%+击杀自动回收换水晶小人
